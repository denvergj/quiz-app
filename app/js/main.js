...
/***/ function(module, exports, __webpack_require__) {
	...
	var _quizQuestionListJsx = __webpack_require__(162);

	var _quizQuestionListJsx2 = _interopRequireDefault(_quizQuestionListJsx);

	var _quizResultsJsx = __webpack_require__(164);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _QuestionJsx = __webpack_require__(163);
					...
					_react2['default'].createElement(
						...
						this.props.question.choices.map(function (choice) {
							return _react2['default'].createElement(
								...
								choice.id,
								' ',
								_react2['default'].createElement('input', { type: 'radio', onChange: _this.onChange.bind(_this), name: 'radio', value: choice.id }),
								choice.text
							);
						})
					)
